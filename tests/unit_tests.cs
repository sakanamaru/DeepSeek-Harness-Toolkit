...
public static class UnitTests
{
    ...
    public static void Main()
    {
        ...
        Check(Program.Test.CmpVer("0.1.1", "0.1.1") == 0 && Program.Test.CmpVer("0.1.1-rc.2", "0.1.1") < 0 && Program.Test.CmpVer("0.1.1-rc.2", "0.2.0") < 0 && Program.Test.CmpVer("2.1.0-beta.1", "2.1.0") < 0 && Program.Test.CmpVer("2.1.0-rc.1", "2.1.0-rc.2") < 0 && Program.Test.CmpVer("2.1.0-rc.2", "2.1.0-rc.10") < 0 && Program.Test.CmpVer("2.1.0-rc.10", "2.1.0-rc.2") > 0 && Program.Test.CmpVer("2.1.0-alpha", "2.1.0-beta") < 0 && Program.Test.CmpVer("2.1.0-rc.1", "2.1.0-rc.1") == 0, "CompareVersions: release > rc; rc.1 < rc.2 < rc.10; alpha < beta; equal rc equal");
